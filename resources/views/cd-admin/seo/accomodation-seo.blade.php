...
@section('content')
	...
	<h1>
  	...
  	<ol class="breadcrumb">
    	<li><i class="fa fa-dashboard"></i>Dashboard->Accomodation->SEO</li>
  	</ol>
	</section>
    ...
    <div class="col-md-10 box1">
      <div class="box box-default">
        <div class="box-header text text-center">
          <h1 class="box-title "><h2>Accomodation SEO</h2></h1>
        </div>
        <div class="box-body">
          <!-- Date dd/mm/yyyy -->
		 ...
		 <hr>
          <div class="row">
            ...
            <div class="col-md-4">
              ...
              <a href=""><button class="btn btn-primary  test1" type="submit"><b>Update Accomodation SEO</b></button></a>
